...
export interface MultiwrapInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "balanceOf" | "balanceOfBatch" | "burn" | "burnBatch" | "contractType" | "contractURI" | "contractVersion" | "getDefaultRoyaltyInfo" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getRoyaltyInfoForToken" | "grantRole" | "hasRole" | "initialize" | "isApprovedForAll" | "isTrustedForwarder" | "multicall" | "name" | "nextTokenIdToMint" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "owner" | "renounceRole" | "revokeRole" | "royaltyInfo" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "totalShares" | "totalSupply" | "unwrap" | "uri" | "wrap"): FunctionFragment;
...
export interface Multiwrap extends BaseContract {
    ...
    functions: {
        ...
        totalShares(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        totalSupply(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        unwrap(_tokenId: BigNumberish, _amountToRedeem: BigNumberish, _sendTo: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        uri(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        wrap(_wrappedContents: MultiTokenTransferLib.MultiTokenStruct, _shares: BigNumberish, _uriForShares: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        totalShares(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        totalSupply(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        unwrap(_tokenId: BigNumberish, _amountToRedeem: BigNumberish, _sendTo: string, overrides?: CallOverrides): Promise<void>;
        uri(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        wrap(_wrappedContents: MultiTokenTransferLib.MultiTokenStruct, _shares: BigNumberish, _uriForShares: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
    ...
    populateTransaction: {
        ...
        totalShares(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
