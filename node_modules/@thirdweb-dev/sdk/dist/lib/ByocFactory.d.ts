...
export interface ByocFactoryInterface extends utils.Interface {
    functions: {
        ...
        "deployInstance(address,bytes,bytes,bytes32,uint256,(string,string,address))": FunctionFragment;
        "deployInstanceProxy(address,address,bytes,bytes32,uint256,(string,string,address))": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "contractURI" | "deployInstance" | "deployInstanceProxy" | "getPublishMetadataUri" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "grantRole" | "hasRole" | "isPaused" | "isTrustedForwarder" | "owner" | "renounceRole" | "revokeRole" | "setContractURI" | "setOwner" | "setPause" | "setThirdwebInfo" | "supportsInterface"): FunctionFragment;
    encodeFunctionData(functionFragment: "DEFAULT_ADMIN_ROLE", values?: undefined): string;
    encodeFunctionData(functionFragment: "contractURI", values?: undefined): string;
    encodeFunctionData(functionFragment: "deployInstance", values: [
        string,
        BytesLike,
        BytesLike,
        BytesLike,
    ...
    encodeFunctionData(functionFragment: "deployInstanceProxy", values: [
        string,
        string,
        BytesLike,
        BytesLike,
...
export interface ByocFactory extends BaseContract {
    ...
    functions: {
        ...
        deployInstance(_publisher: string, _contractBytecode: BytesLike, _constructorArgs: BytesLike, _salt: BytesLike, _value: BigNumberish, _thirdwebInfo: ThirdwebContract.ThirdwebInfoStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployInstanceProxy(_publisher: string, _implementation: string, _initializeData: BytesLike, _salt: BytesLike, _value: BigNumberish, _thirdwebInfo: ThirdwebContract.ThirdwebInfoStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        contractURI(overrides?: CallOverrides): Promise<string>;
        deployInstance(_publisher: string, _contractBytecode: BytesLike, _constructorArgs: BytesLike, _salt: BytesLike, _value: BigNumberish, _thirdwebInfo: ThirdwebContract.ThirdwebInfoStruct, overrides?: CallOverrides): Promise<string>;
        deployInstanceProxy(_publisher: string, _implementation: string, _initializeData: BytesLike, _salt: BytesLike, _value: BigNumberish, _thirdwebInfo: ThirdwebContract.ThirdwebInfoStruct, overrides?: CallOverrides): Promise<string>;
        getPublishMetadataUri(overrides?: CallOverrides): Promise<string>;
        getRoleAdmin(role: BytesLike, overrides?: CallOverrides): Promise<string>;
        getRoleMember(role: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<string>;
        getRoleMemberCount(role: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
