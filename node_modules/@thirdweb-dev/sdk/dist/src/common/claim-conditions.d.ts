 ...
 * @internal
 */
export declare function transformResultToClaimCondition(pm: IDropClaimCondition.ClaimConditionStructOutput, tokenDecimals: number, provider: Provider, merkleMetadata: Record<string, string>, storage: IStorage): Promise<ClaimCondition>;
