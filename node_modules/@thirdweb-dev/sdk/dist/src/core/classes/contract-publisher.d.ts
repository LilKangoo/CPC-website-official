...
import { AbiFunction, ContractParam, CustomContractMetadata, PublishedContract } from "../../schema/contracts/custom";
/**
...
export declare class ContractPublisher extends RPCConnectionHandler {
     ...
     * @param metadataUri
     */
    fetchFullContractMetadata(metadataUri: string): Promise<import("../../schema/contracts/custom").PublishedMetadata>;
    /**
     * @internal
     * @param address
     */
